...
public enum Messages {
    ...
    RELATIONSHIP_CHANGED("&aYou have successfully declared the guild %args0% as an %args1%."),
    ...
    GUILD_ANNOUNCEMENT_DECLARE("&aThe guild %args0% has declared %args1% as an %args2%."),
